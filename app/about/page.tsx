...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col space-y-10">
      ...
      <div className={fineprint()}>P.S. Content on this website is entirely free. Please credit {<a href="https://www.instagram.com/chasing_sunrise_photography" target="_blank" rel="noopener noreferrer" className="underline text-blue-600">@chasing_sunrise_photography</a>}&nbsp;
      if you use any content in any capacity. I’m happy to send you full-resolution images if you direct message me on Instagram. Any replies and correspondence will entirely depend on how busy my surgical schedule happens to be!</div>
